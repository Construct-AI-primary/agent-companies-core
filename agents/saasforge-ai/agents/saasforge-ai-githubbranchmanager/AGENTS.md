...
role: general
description: >
  Use when managing GitHub repositories, branch workflows, merge operations, or GitHub Actions configurations for client systems. This skill handles version control operations.
