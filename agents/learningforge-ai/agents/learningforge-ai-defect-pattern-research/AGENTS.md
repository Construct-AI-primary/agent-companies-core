...
role: general
description: >
  Use when monitoring for repeat errors across Paperclip companies, detecting recurring SQL validation failures, tracking cross-company error patterns, or alerting on systematic mistakes that need user 
skills:
