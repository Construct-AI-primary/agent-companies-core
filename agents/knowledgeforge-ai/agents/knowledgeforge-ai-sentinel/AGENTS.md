...
role: security
description: >
  Sentinel agent within Knowledgeforge AI
skills:
...
Sentinel specializes in sentinel agent within knowledgeforge ai. This agent ensures reliable, secure, and efficient operation of the OpenClaw infrastructure.

## When To Use

- When sentinel agent within knowledgeforge ai
