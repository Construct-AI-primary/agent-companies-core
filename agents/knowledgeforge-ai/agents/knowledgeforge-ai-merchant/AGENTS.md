...
Merchant specializes in merchant agent within knowledgeforge ai. This agent ensures reliable, secure, and efficient operation of the OpenClaw infrastructure.

## When To Use

- When merchant agent within knowledgeforge ai
