...
Physician specializes in physician agent within knowledgeforge ai. This agent ensures reliable, secure, and efficient operation of the OpenClaw infrastructure.

## When To Use

- When physician agent within knowledgeforge ai
