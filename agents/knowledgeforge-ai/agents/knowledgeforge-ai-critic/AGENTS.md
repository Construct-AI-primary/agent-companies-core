...
role: doc-analyzer
description: >
  Critic agent within Knowledgeforge AI
skills:
...
Critic specializes in critic agent within knowledgeforge ai. This agent ensures reliable, secure, and efficient operation of the OpenClaw infrastructure.

## When To Use

- When critic agent within knowledgeforge ai
