...
role: general
description: >
  Routes Supabase database operations, SQL generation, authentication troubleshooting, and performance...
skills:
...
- When routes supabase database operations, sql generation, authentication troubleshooting, and performance...
